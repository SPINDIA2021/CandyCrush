package com.candycrush.game.network;
...
import com.candycrush.game.Preferences;
import com.candycrush.game.R;
import com.candycrush.game.Util;
    ...
    public IApi getRetrofit(boolean isShowLoading, final boolean pass) {
        ...
        if (Util.isOnline(context)) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .build();
            if (isShowLoading && context instanceof CordovaActivity)
                showLoading();
